...
var User = new Schema({
    ...
    firstname: {
      type: String,
      required : true,
      enum : ["Daniel", "David", "Abel", "Francisco Javier", "Juan", "Manuel", "Gregorio Oscar", "Jose Manuel", "Manuel Yago", "Alberto", "Marcos Antonio", "Gustavo Jose", "Manuel", "Carlos", "Ricardo", "Roberto", "Vicente Javier", "Iago", "Javier", "Alvaro", "Ana Isabel", "Fernando", "Jorge", "Antonio", "Virginia", "Monica", "Arturo", "Felix Javier", "Borja Jose", "Marcos", "Alejandro", "Vicente", "Ignacio", "Cesar", "Valeriano", "Alejandro Miguel", "Pedro Angel Del", "Julio Crispin", "Rocio", "Marina", "Jose Miguel", "Miguel Angel", "Sergio", "Hector", "Victor", "Juan Manuel", "Diego", "Jose David", "Susana", "Antonio", "Abel", "Jesus", "Alvaro Miguel", "Carmen", "Jorge", "Jose Ignacio", "Alfredo", "Mario", "Rafael", "Federico David", "Maria Dolores", "Marcin", "M Vicenta", "Raquel", "Adrian", "Cayetano", "Roberto Carlos", "Jesus", "Miguel Angel", "Andres", "Sergio De La", "Pedro Jose", "Jesus", "Miguel", "Jose Emilio"]
